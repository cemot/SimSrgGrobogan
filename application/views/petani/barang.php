                                ...
                                foreach ($data as $barang): ?>
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <!-- <a class="btn btn-info" href="<?php echo base_url('petani/pengajuan/show/'.$barang->id_gudang); ?>"><i class="material-icons">assignment</i> Detail</a> -->
                                            <button class="btn btn-info" onclick="belumAda()"><i class="material-icons">assignment</i> Cetak</button>
